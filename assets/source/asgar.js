...
export class Asgar {
    ...
    darkModeEvent() {
        ...
        if ((this.utils.checkSystemDarkMode() && this.storage.get("asgar-dm") === null) || this.storage.get("asgar-dm")) {
            setDarkMode(true);
        }
     ...
     */
    getCurrentPage() {
        return this.pages.find(({ name }) => name === this.utils.getCurrentPageName());
    }
